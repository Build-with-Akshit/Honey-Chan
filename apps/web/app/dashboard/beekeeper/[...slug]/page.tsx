  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8 border-b border-amber-100 pb-6">
        <h1 className="text-2xl font-bold text-gray-900">{title === 'Create' ? 'Create Batch' : title} Module</h1>
      ...
      <div className="card bg-white p-12 text-center border-dashed border-2 border-amber-200">
        ...
        <p className="text-gray-500 max-w-md mx-auto text-sm">
          The <strong>{title === 'Create' ? 'Create Batch' : title}</strong> module for the <strong>{user?.role}</strong> portal is currently being connected to the blockchain smart contracts. Check back later!
        </p>
