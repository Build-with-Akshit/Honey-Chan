...
export const translations = {
  en: {
    ...
    /* ── v2 scanner ── */
    "scan.badge": "KVIC HONEY MISSION · BLOCKCHAIN VERIFICATION",
    "scan.title": "Scan Honey Jar QR Code",
    "scan.subtitle": "Verify authenticity, hive origin, test reports, and supply chain journey.",
    "scan.tab.camera": "Live Camera",
    "scan.tab.upload": "Upload Image",
    "scan.tab.manual": "Batch ID",
    "scan.cameraReady": "Camera Ready",
    "scan.cameraReadySub": "Position the QR code inside the frame to scan automatically",
    "scan.startCamera": "Start Live Camera",
    "scan.stopCamera": "Stop Camera",
    "scan.flipCamera": "Flip Camera",
    "scan.scanningActive": "Scanning... Hold steady over QR code",
    "scan.uploadPrompt": "Upload Honey Jar QR Code",
    "scan.uploadSub": "Drag & drop jar label photo or click to browse",
    "scan.uploadFormats": "Supports JPG, PNG, WEBP up to 10MB",
    "scan.uploadBrowse": "Select Image",
    "scan.manualTitle": "Enter Batch Identifier",
    "scan.manualDesc": "Find the batch number printed beneath the QR code or on the jar label.",
    "scan.demoBatches": "Or test with verified sample batches:",
    "scan.demo1": "Mustard Honey · Sonipat (Verified 96%)",
    "scan.demo2": "Acacia Honey · Kashmir (Lab Tested)",
    "scan.demo3": "Sundarbans Wild Honey (100% Pure)",
    "scan.guide.title": "How Verification Works",
    "scan.guide.step1.title": "100% On-Chain Seal",
    "scan.guide.step1.desc": "Every harvest batch hash is permanently minted on public blockchain ledger.",
    "scan.guide.step2.title": "Lab Purity Certified",
    "scan.guide.step2.desc": "Tested for moisture (<20%), sucrose, and zero C4 sugar adulteration.",
    "scan.guide.step3.title": "Apiary to Table",
    "scan.guide.step3.desc": "Trace the exact beekeeper cluster, extraction date, and journey stages.",
    "scan.guide.locationTitle": "Where is the QR code located?",
    "scan.guide.locationDesc": "Look for the HoneyChain QR badge on the jar lid, side sticker, or invoice receipt.",
  ...
  hi: {
    ...
    /* ── v2 scanner ── */
    "scan.badge": "केवीआईसी हनी मिशन · ब्लॉकचेन सत्यापन",
    "scan.title": "शहद की बोतल का QR स्कैन करें",
    "scan.subtitle": "शहद की शुद्धता, छत्ते का स्रोत, लैब रिपोर्ट और सप्लाई चेन का पूरा सफ़र जाँचें।",
    "scan.tab.camera": "लाइव कैमरा",
    "scan.tab.upload": "फोटो अपलोड",
    "scan.tab.manual": "बैच नंबर",
    "scan.cameraReady": "कैमरा तैयार है",
    "scan.cameraReadySub": "शहद का QR कोड अपने आप स्कैन करने के लिए फ्रेम में लाएं",
    "scan.startCamera": "कैमरा चालू करें",
    "scan.stopCamera": "कैमरा बंद करें",
    "scan.flipCamera": "कैमरा बदलें",
    "scan.scanningActive": "स्कैनिंग जारी है... QR कोड को फ्रेम में रखें",
    "scan.uploadPrompt": "शहद के डिब्बे का QR अपलोड करें",
    "scan.uploadSub": "लेबल की फोटो यहाँ खींच कर डालें या गैलरी से चुनें",
    "scan.uploadFormats": "JPG, PNG, WEBP समर्थित (10MB तक)",
    "scan.uploadBrowse": "फोटो चुनें",
    "scan.manualTitle": "बैच नंबर दर्ज करें",
    "scan.manualDesc": "QR कोड के नीचे या बिल पर लिखा बैच नंबर यहाँ लिखें।",
    "scan.demoBatches": "या जाँचे गए सैंपल बैच से टेस्ट करें:",
    "scan.demo1": "सरसों का शहद · सोनीपत (सत्यापित)",
    "scan.demo2": "बबूल/अकेशिया शहद · कश्मीर (लैब पास)",
    "scan.demo3": "सुंदरबन जंगली शहद (100% शुद्ध)",
    "scan.guide.title": "सत्यापन कैसे काम करता है",
    "scan.guide.step1.title": "100% ब्लॉकचेन सील",
    "scan.guide.step1.desc": "हर बैच का डिजिटल हैश हमेशा के लिए ब्लॉकचेन पर सुरक्षित दर्ज होता है।",
    "scan.guide.step2.title": "लैब टेस्ट पास",
    "scan.guide.step2.desc": "नमी (20% से कम), सुक्रोज और चीनी मिलावट की संपूर्ण जाँच।",
    "scan.guide.step3.title": "छत्ते से घर तक",
    "scan.guide.step3.desc": "किसान, छत्ता, निकालने की तारीख और दुकान तक का पूरा रास्ता देखें।",
    "scan.guide.locationTitle": "QR कोड कहाँ मिलेगा?",
    "scan.guide.locationDesc": "शहद की शीशी के ढक्कन, साइड लेबल या बिल रसीद पर हनीचेन QR कोड देखें।",
